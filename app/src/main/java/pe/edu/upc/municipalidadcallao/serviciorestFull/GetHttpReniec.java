...
public class GetHttpReniec extends AsyncTask<String, Void, String> {
    ...
    public GetHttpReniec(Usuario httpObject, RecyclerView httpRecycler, RecyclerView.Adapter httpAdapter, Context httpContext) {
    ...
    public GetHttpReniec( Context httpContext) {
        this.httpContext = httpContext;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            jsonParam.put("nombres", params[2]);
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            this.httpObject = new Usuario(nombres, apellidoPaterno, apellidoMaterno, distrito, direccion, "SAN MIGUEL", "158", "159");
